      ...
      >
        <a href="https://www.google.com">
          ...
          >
            ...
            />
            <img
              class="w-[60px] h-[60px] my-auto object-cover object-center rounded-full"
    ...
    <ul class="flex flex-wrap justify-between">
      ...
      >
        ...
        >
          <div
            ref="filters"
            class="w-[200px] h-[200px] my-auto bg-black absolute rounded-full opacity-0 flex justify-center align-middle"
          >
            <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              class="fill-white bg-inherit opacity-100 m-auto"
              width="45.999px"
              height="45.999px"
          ...
          <img
            class="w-[200px] h-[200px] my-auto object-cover object-center rounded-full"
            :src="artist.images[0].url"
            alt="artist image"
          >
        </div>
