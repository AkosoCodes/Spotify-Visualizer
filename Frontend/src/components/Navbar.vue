  ...
  <div class="bg-black fixed flex flex-col top-0 left-0 z-10 min-h-[100vh] justify-between w-[120px] shadow-med">
    ...
    <div class=" w-[50px] mx-auto mt-[30px]">
      ...
      >
        <img
          class="bg-current"
          src="../assets/icons/Spotify_Icon_Green.png"
          alt="Spotify_Logo"
        >
      </a>
    </div>
    ...
    <ul class="flex flex-col">
      ...
      <li
        :class="{
          ...
          'h-[70px] w-full text-center flex flex-col justify-center':true}"
        @click="activeSection = 'topArtists' "
      >
        <router-link
          v-slot="{ navigate }"
          to="/topArtists"
    ...
    <div class="fill-gray w-[40px] mx-auto mb-[30px] hover:fill-white">
      <a
        href="https://github.com/AkosoCodes/Spotify-App"
        target="_blank"
      >
        <svg
          class="bg-current"
